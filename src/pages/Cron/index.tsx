...
export function Cron() {
  ...
  const handleCreateTemplate = useCallback(async (input: CronJobCreateInput) => {
    try {
      await createJob(input);
      toast.success(t('toast.created'));
    } catch (error) {
      console.error('Failed to create cron job from template:', error);
  ...
  if (loading) {
    return (
      <div className="flex flex-col -m-6 bg-[#FFFFFF] dark:bg-background min-h-[calc(100vh-2.5rem)] items-center justify-center">
  ...
  return (
    <div className="flex flex-col -m-6 bg-[#FFFFFF] dark:bg-background h-[calc(100vh-2.5rem)] overflow-hidden">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <button
                  onClick={() => handleCreateTemplate({
                    name: '每日行业资讯',
                    message: '每天早上8点，给我推送最新行业资讯和新闻动态，帮助我了解市场趋势',
                    schedule: '0 8 * * *',
                    enabled: true,
                  })}
                  className="group p-5 rounded-2xl bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-950/30 dark:to-indigo-950/30 border border-blue-200/50 dark:border-blue-800/30 hover:shadow-lg hover:scale-[1.02] transition-all cursor-pointer text-left"
                >
                  <div className="flex items-center justify-between mb-3">
                    <div className="h-12 w-12 rounded-full bg-blue-500/10 dark:bg-blue-400/10 flex items-center justify-center text-2xl shadow-sm">
                      📰
                    </div>
                    <div className="h-8 w-8 rounded-full bg-white dark:bg-black/20 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
                      <Plus className="h-4 w-4 text-blue-600 dark:text-blue-400" />
                    </div>
                  </div>
                  <h3 className="text-base font-semibold text-foreground mb-2">每日行业资讯</h3>
                  <p className="text-[13px] text-foreground/70 leading-relaxed">
                    每天早上8点，给我推送这些类【你所在的行业，例如：人工智能/金融/新能源】的最新行业资讯和新闻动态，帮助我了解市场趋势
                  </p>
                </button>
                ...
                <button
                  onClick={() => handleCreateTemplate({
                    name: '市场舆情追踪',
                    message: '每天中午12点，帮我搜索并总结竞争对手【某公司或某产品】过去24小时在全网的最新动态和舆情报道',
                    schedule: '0 12 * * *',
                    enabled: true,
                  })}
                  className="group p-5 rounded-2xl bg-gradient-to-br from-amber-50 to-orange-50 dark:from-amber-950/30 dark:to-orange-950/30 border border-amber-200/50 dark:border-amber-800/30 hover:shadow-lg hover:scale-[1.02] transition-all cursor-pointer text-left"
                >
                  <div className="flex items-center justify-between mb-3">
                    <div className="h-12 w-12 rounded-full bg-amber-500/10 dark:bg-amber-400/10 flex items-center justify-center text-2xl shadow-sm">
                      👤
                    </div>
                    <div className="h-8 w-8 rounded-full bg-white dark:bg-black/20 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
                  ...
                  <h3 className="text-base font-semibold text-foreground mb-2">市场舆情追踪</h3>
                  <p className="text-[13px] text-foreground/70 leading-relaxed">
                    每天中午12点，帮我搜索并总结竞争对手【某公司或某产品】过去24小时在全网的最新动态和舆情报道
                  </p>
                </button>
                ...
                <button
                  onClick={() => handleCreateTemplate({
                    name: '工作周报',
                    message: '每周五下午6点，帮我根据本周工作文档、表格生成我的周报，包括本周工作、任务进度、下周事项',
                    schedule: '0 18 * * 5',
                    enabled: true,
                  })}
                  className="group p-5 rounded-2xl bg-gradient-to-br from-emerald-50 to-teal-50 dark:from-emerald-950/30 dark:to-teal-950/30 border border-emerald-200/50 dark:border-emerald-800/30 hover:shadow-lg hover:scale-[1.02] transition-all cursor-pointer text-left"
                >
                  <div className="flex items-center justify-between mb-3">
                    <div className="h-12 w-12 rounded-full bg-emerald-500/10 dark:bg-emerald-400/10 flex items-center justify-center text-2xl shadow-sm">
                      📊
                    </div>
                    <div className="h-8 w-8 rounded-full bg-white dark:bg-black/20 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
                  ...
                  <h3 className="text-base font-semibold text-foreground mb-2">工作周报</h3>
                  <p className="text-[13px] text-foreground/70 leading-relaxed">
                    每周五下午6点，帮我根据本周工作，文档、表格生成我的周报，包括本周工作，任务进度，下周事项
                  </p>
                </button>
            </div>
          </div>
