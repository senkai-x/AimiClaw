...
export function TitleBar() {
  if (isMac) {
    ...
    return <div className="drag-region h-10 shrink-0 border-b bg-[#F7F8FA]" />;
  }
...
function WindowsTitleBar() {
  ...
  return (
    <div className="drag-region flex h-10 shrink-0 items-center justify-end border-b bg-[#F7F8FA]">
