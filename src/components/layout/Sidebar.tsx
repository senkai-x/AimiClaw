...
import logoImg from '@/assets/aimiclaw-logo.png';
...
export function Sidebar() {
  ...
  return (
    <aside
      className={cn(
        'flex shrink-0 flex-col border-r bg-[#F7F8FA] dark:bg-background transition-all duration-300',
    ...
    >
      ...
      <div className={cn("flex items-center p-2 h-12", sidebarCollapsed ? "justify-center" : "justify-between")}>
        {!sidebarCollapsed && (
          <div className="flex items-center gap-2 px-2 overflow-hidden">
            <img src={logoImg} alt="AimiClaw" className="h-5 w-auto shrink-0" />
      ...
      <div className="p-2 mt-auto">
        ...
        >
          ...
          {!sidebarCollapsed && (
            <span className="flex-1 text-left overflow-hidden text-ellipsis whitespace-nowrap">小小销售</span>
          )}
        </div>
      </div>
